...
class PiplinedCPU(memAddrWidth: Int, memDataWidth: Int) extends Module {
    ...
    /* Wire Connect */
    // === IF stage reg (PC reg) ======================================================
    stage_IF.io.Stall := (controller.io.Hcf||controller.io.Stall_EXE_ID_DH||controller.io.Stall_MEM_ID_DH||controller.io.Stall_WB_ID_DH||controller.io.Stall_MA) && !controller.io.Flush_BH // To Be Modified
    ...
    stage_ID.io.Stall := (controller.io.Hcf||controller.io.Stall_EXE_ID_DH||controller.io.Stall_MEM_ID_DH||controller.io.Stall_WB_ID_DH||controller.io.Stall_MA) && !controller.io.Flush_BH     // To Be Modified
    ...
    // === EXE stage reg ==============================================================
    stage_EXE.io.Flush := controller.io.Flush_BH      // To Be Modified
    stage_EXE.io.Stall_DH := (controller.io.Hcf||controller.io.Stall_EXE_ID_DH||controller.io.Stall_MEM_ID_DH||controller.io.Stall_WB_ID_DH)   // To Be Modified
    stage_EXE.io.Stall_MA := controller.io.Stall_MA
    ...
    stage_WB.io.Stall_MA := controller.io.Stall_MA
    ...
    io.Flush := controller.io.Flush_BH      // modified
    io.Stall_DH := controller.io.Stall_EXE_ID_DH||controller.io.Stall_MEM_ID_DH||controller.io.Stall_WB_ID_DH   // modified
